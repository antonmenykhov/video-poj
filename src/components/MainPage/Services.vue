...
.service-wrapper::before {
    position: absolute;
    content: '';
    background: rgba(37, 37, 37, 0.405);
    top: 0;
    right: 0;
    left: 0;
    bottom: 0;
...
.service-title{
    ...
    width: 70%;
    transition: all .4s cubic-bezier(0.075, 0.42, 0.165, 1);
}
.service-description{
    position: relative;
    z-index: 3;
...
.service-wrapper:hover.service-wrapper::after{
    opacity: 1;
    transform: scaleX(1);
}
...
.service-wrapper:hover .service-button{
    opacity: 0;
}
